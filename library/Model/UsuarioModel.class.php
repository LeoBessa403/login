...
class  UsuarioModel extends AbstractModel
{
    ...
    public function getUsuariosCoordenadores()
    {
        $tabela = UsuarioEntidade::TABELA . " usu" .
            " inner join " . UsuarioPerfilEntidade::TABELA . " up" .
            " on usu." . UsuarioEntidade::CHAVE . " = up." . UsuarioEntidade::CHAVE;

        $campos = "usu.*";
        $pesquisa = new Pesquisa();
        $where = $pesquisa->getClausula([
            CO_PERFIL => 5,
