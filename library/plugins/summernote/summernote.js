    ...
    var EventHandler = function () {
        ...
        var makeLayoutInfo = function (descendant) {
            ...
            return {
                ...
                toolbar: function () {
                    return welEditor.find('.note-toolbar');
                },
                editable: function () {
                    return welEditor.find('.note-editable');
                },
                statusbar: function () {
                    return welEditor.find('.note-statusbar');
                },
                popover: function () {
                    return welEditor.find('.note-popover');
                },
                handle: function () {
                    return welEditor.find('.note-handle');
                },
                dialog: function () {
                    return welEditor.find('.note-dialog');
                }
            };
        };
    ...
    var Renderer = function () {
        ...
        var createTooltip = function (welContainer, sPlacement) {
            welContainer.find('button').each(function (i, elBtn) {
                ...
                if (sShortcut) {
                    welBtn.attr('title', function (i, v) {
                        return v + ' (' + sShortcut + ')'
                    });
                }
        ...
        var createLayout = this.createLayout = function (welHolder, nHeight, nTabsize, aToolbarSetting) {
            //already created
            if (welHolder.next().hasClass('note-editor')) {
                return;
            }
        ...
        var layoutInfoFromHolder = this.layoutInfoFromHolder = function (welHolder) {
            ...
            if (!welEditor.hasClass('note-editor')) {
                return;
            }
...
if ('function' !== typeof Array.prototype.reduce) {
    Array.prototype.reduce = function (callback, opt_initialValue) {
        ...
        if (1 < arguments.length) {
            value = opt_initialValue, isValueSet = true;
        }
