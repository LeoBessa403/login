        ...
        var DataTable = function (oInit) {
			 ...
			 */
                if (!oLanguage.sEmptyTable && oLanguage.sZeroRecords &&
                    oDefaults.sEmptyTable === "Não há Registros cadastrados") {
	 ...
	 *    }
                    ...
                    "error": function (xhr, error, thrown) {
                        if (error == "parsererror") {
                            oSettings.oApi._fnLog(oSettings, 0, "DataTables warning: JSON data from " +
                                "servidor não pôde ser analisado. Isto é causado por um JSON formatação de erro.");
                        }
                    }
                });
            },
		 ...
		 *    } );
            ...
            "oLanguage": {
                 ...
                 *  @type string
                 *  @default Não há Registros cadastrados
                 *  @dtopt Language
                 *
                 *  @example
                 *    $(document).ready( function() {
			 ...
			 *    } );
                 */
                "sInfo": "Registros do _START_ ao _END_ de _TOTAL_ Encontrados",
			 ...
			 *    } );
                 */
                "sInfoEmpty": "Nenhum Registros Encontrados",
			 ...
			 *    } );
                 */
                "sZeroRecords": "Não há registros encontrados"
            },
